...
2. [Architettura della proposta](#2-architettura-della-proposta)
3. [Fase 1: dal dato puntuale alla valutazione lungo il fiume](#3-fase-1--dal-dato-puntuale-alla-valutazione-lungo-il-fiume)
   - 3.1 [Struttura del problema](#31-struttura-del-problema)
   - 3.2 [Impostazioni possibili](#32-impostazioni-possibili)
   - 3.3 [Dati in ingresso](#33-dati-in-ingresso)
   - 3.4 [Orizzonte utile](#34-orizzonte-utile)
   - 3.5 [Soglie nei punti non strumentati](#35-soglie-nei-punti-non-strumentati)
...
- livello osservato dalla topografia.
...
un operatore logistico ragiona per magazzini e teme il falso allarme ed un'amministrazione comunale ha metodi.
